export const BACKEND_API_HOST   = process.env.BACKEND_API_HOST || 'http://mxsh.lvh.me:4000'
...
export const FRONTEND_API_HOST   = process.env.FRONTEND_API_HOST || 'http://mxsh.lvh.me:3000'
